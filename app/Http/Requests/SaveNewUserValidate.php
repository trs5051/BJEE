...
class SaveNewUserValidate extends FormRequest
{
	/**
	...
	public function rules()
	{
		return [
			...
			'userrole' => 'required|numeric|digits_between:1,4',
		];
	}
	public function messages()
	{
		return [
			...
			'userrole.digits_between' => 'User Role is Required',
			'userrole.numeric' => 'User Role is Required',
		];
	}
}
