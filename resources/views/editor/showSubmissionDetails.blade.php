		...
		<div class="col-md-12">
			<div class="card">
				...
				<div class="card-body">
					...
					<table class="table table-striped">
						...
						<tbody>
							...
							<tr>
								<td>Accepted
									<small>
										Bangladesh Journal of Extension Education strongly recommend that authors save and retain their own
					...
					<!--	<div class="card-body">-->
					<!--		<p class="card-text">-->
					<!--			Submission is in {{ $submission->status->name }}-->
					...
					<!--							<tr>-->
					<!--								<td>{{ $review['rating'] }}</td>-->
					<!--								<td>{{ $review['comments_to_editor'] }}</td>-->
					<!--								<td>-->
					<!--									@if ($review['file_to_editor'] === null)-->
