...
@section('title-tag', 'Add New Volume | ')
        ...
        <div class="page-header float-right">
          <div class="page-title">
            <ol class="breadcrumb text-right">
              ...
              <li><a href="{{ route('editor.journals') }}">Volumes</a></li>
              <li class="active">Add Volume</li>
            </ol>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-12">
        <div class="card">
          ...
          <div class="card-body card-block">
            ...
            <form action="{{ route('editor.store-volume') }}" method="post" enctype="multipart/form-data" id="volume-add-form">
              {{csrf_field()}}
              <div class="row">
                <div class="col-lg-8">
